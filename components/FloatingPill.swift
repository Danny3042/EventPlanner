...
struct FloatingPillView: UIViewRepresentable {
    ...
    func makeUIView(context: Context) -> SCNView {
        ...
        let pillNode = createFloatingPill(medicationName: medicationName, dosage: dosage, radius: radius)
...
private func createFloatingPill(medicationName: String, dosage: String, radius: Float) -> SCNNode {
    ...
    cylinder.materials = [whiteMaterial]
    hemisphereTop.materials = [redMaterial]
    hemisphereBottom.materials = [whiteMaterial]
